...
client for access to the storage bucket. The example below shows which sections
of the DSN correspond to the different parameter::


    s3://AKAIIEJALP7LUT6ODIJA:TZJYGCfUZheXG%2BwANMFabbotgBs6d2lxZW06OIbD@example-test-68564d3f78d04cd2935f-8f20b19.aldryn-media.io.s3.amazonaws.com/?domain=example-test-68564d3f78d04cd2935f-8f20b19.aldryn-media.io
    --   -------------------- ------------------------------------------ --------------------------------------------------------- ----------------
     |             |                               |                                                    |
    protocol      key                            secret                                             bucket name                            S3 host
     |             |                               |                                                    |
    --   --------------------------- -------------------------------------------- ----------------------------------------------------- ----------                                                        ---------
    s3://EXO52e55eb39187195ffdd72219:iITF12F1t123tim9zBxITexrvL_bAghgK_z4w1hEuu00@example-test-765482644ac540dbb23367cf3837580b-f0596a8.sos.exo.io/?auth=s3
In table form:
...
secret          TZJYGCfUZheXG%2BwANMFabbotgBs6d2lxZW06OIbD (see :ref:`DSN-reserved-characters`)
