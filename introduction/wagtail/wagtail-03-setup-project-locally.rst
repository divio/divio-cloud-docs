...
..  note::
    ...
    If you didn't previously log in to the cloud site before setting up the application locally, you'll need to add a 
    user to the database before you can log in. The :ref:`Divio SSO system <divio-cloud-sso>` allows you to do this 
    from the Django login page with the **Add user** option.
